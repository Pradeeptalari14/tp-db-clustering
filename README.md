# 🗄️ Database Clustering Studio
> Scaffold Postgres Patroni failover configurations, Redis Sentinel topologies, and cluster sync guides.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/db-clustering/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/db-clustering/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-db-clustering.git
cd tp-db-clustering
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/db-clustering/) |
